<template>
    <div class="container-contenido d-flex">
        <div class="tabs-container">
            ...
            <div class="tabs-item" @click="handleTabClick(tabNames.CATEGORIASADMIN)" :class="{ 'tabs-item-active': activeTabName === tabNames.CATEGORIAS}">
                CATEGORÍAS
            </div>
            <v-spacer></v-spacer>
...
export default {
    data: () => ({
        tabs: {
            ...
            [tabNames.CATEGORIASADMIN]: CategoriasAdmin
        },
        tabNames,
        currentTab: Usuarios,
